/*------------------------------------------------------------------------------
  ...
  short range operation. See GetDistancePWM and GetDistanceI2C for simpler
...
void setup()
{
  ...
  /*
    ...
    lidarliteAddress: Default LIDARLITE_ADDR_DEFAULT. Fill in new address here if changed. See
  ...
  */
  ...
  /*
    ...
    lidarliteAddress: Default 0x62. Fill in new address here if changed. See
      operating manual for instructions.
  */
  myLidarLite.write(0x02, 0x10); // Maximum acquisition count of 0x10. (default is 0x80)
...
int distanceFast(bool biasCorrection)
{
  ...
  // I2C transaction finishes before new distance measurement data is acquired.
  Wire.beginTransmission(LIDARLITE_ADDR_DEFAULT);
  Wire.write(0x8f);
  Wire.endTransmission();
